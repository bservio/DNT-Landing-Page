...
const FontChanger = () => {
  ...
  const fonts = useMemo(
    () => ["Albra Bold", "FiraCode", "Intro Inline", "DidotBoldItalic"],
    []
  );
  const words = useMemo(
    () => ["inovação", "educação", "CONEXÃO", "TRANSFORMAÇÃO"],
    []
  );
  ...
  return (
    <div>
      <h1
        className="text-4xl lg:text-4xl text-[#ffff00] absolute left-0  text-left"
